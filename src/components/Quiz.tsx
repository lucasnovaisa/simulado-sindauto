...
import { Clock, ChevronLeft, ChevronRight, Square, CheckSquare, AlertTriangle } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            <div className="flex items-center space-x-4">
              <h1 className="text-xl font-bold text-gray-800">Simulado Sindauto BA - {userName}</h1>
            ...
            <div className="flex items-center space-x-4">
              <div className={`flex items-center space-x-2 font-mono text-lg font-semibold ${timeColor}`}>
          ...
          <div className="mb-8">
            <div className="flex items-start space-x-3 mb-6">
              <div className="flex-shrink-0 w-8 h-8 bg-red-100 rounded-full flex items-center justify-center">
                <span className="text-red-600 font-semibold text-sm">{currentQuestion + 1}</span>
              </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <span className={`text-base ${isSelected ? 'text-red-800 font-medium' : 'text-gray-700'}`}>
                      {alternative}
                    </span>
                  </div>
                </button>

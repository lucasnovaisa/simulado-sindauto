      ...
      <div className="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-md transform transition-all duration-300 scale-100">
        {showResults ? (
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 text-lg">
              Sua pontuação: {correctAnswers}
            </p>
            <p className="text-sm text-gray-500 mt-1">
              {isApproved
                ? "Parabéns! Você acertou pelo menos 28 questões."
                : "Você precisa acertar pelo menos 28 questões para ser aprovado."}
            </p>
          </div>
        ) : (
          <div className="text-center mb-6">
          ...
          <div className="text-sm text-gray-600 space-y-1">
            ...
            {showResults && (
              <div className="flex justify-between">
                ...
                <span className="font-medium">
                  {correctAnswers} de {answeredQuestions}
                </span>
              </div>
            )}
            <div className="flex justify-between">
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <span>
              {showResults ? "Fazer Novo Simulado" : "Reiniciar Simulado"}
            </span>
          </button>
